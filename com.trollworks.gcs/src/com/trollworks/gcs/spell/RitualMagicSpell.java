...
public class RitualMagicSpell extends Spell {
    ...
    public boolean satisfied(StringBuilder builder, String prefix) {
        ...
        if (college == null || college.isBlank()) {
            if (builder != null) {
                builder.append(MessageFormat.format("{0}Must be assigned to a college\n", prefix));
            }
            return false;
        }
        ...
        if (skill == null) {
            ...
            if (skill == null) {
                if (builder != null) {
                    builder.append(MessageFormat.format("{0}Requires a skill named {1} ({2})\n", prefix, mBaseSkillName, college));
                }
                return false;
            }
        }
