...
public enum SelfControlRollAdjustments {
    ...
    ACTION_PENALTY {
        @Override
        public String toString() {
            return "Includes an Action Penalty for Failure";
        }
        ...
        public String getDescription(SelfControlRoll cr) {
            ...
            return MessageFormat.format("{0} Action Penalty", Numbers.formatWithForcedSign(getAdjustment(cr)));
        }
    ...
    REACTION_PENALTY {
        @Override
        public String toString() {
            return "Includes a Reaction Penalty for Failure";
        }
        ...
        public String getDescription(SelfControlRoll cr) {
            ...
            return MessageFormat.format("{0} Reaction Penalty", Numbers.formatWithForcedSign(getAdjustment(cr)));
        }
    ...
    FRIGHT_CHECK_PENALTY {
        @Override
        public String toString() {
            return "Includes Fright Check Penalty";
        }
        ...
        public String getDescription(SelfControlRoll cr) {
            ...
            return MessageFormat.format("{0} Fright Check Penalty", Numbers.formatWithForcedSign(getAdjustment(cr)));
        }
    ...
    FRIGHT_CHECK_BONUS {
        @Override
        public String toString() {
            return "Includes Fright Check Bonus";
        }
        ...
        public String getDescription(SelfControlRoll cr) {
            ...
            return MessageFormat.format("{0} Fright Check Bonus", Numbers.formatWithForcedSign(getAdjustment(cr)));
        }
    ...
    MINOR_COST_OF_LIVING_INCREASE {
        @Override
        public String toString() {
            return "Includes a Minor Cost of Living Increase";
        }
        ...
        public String getDescription(SelfControlRoll cr) {
            ...
            return MessageFormat.format("{0}% Cost of Living Increase", Numbers.formatWithForcedSign(getAdjustment(cr)));
        }
    ...
    MAJOR_COST_OF_LIVING_INCREASE {
        @Override
        public String toString() {
            return "Includes a Major Cost of Living Increase and Merchant Skill Penalty";
        }
